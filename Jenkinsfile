pipeline {
    ...
    parameters{
        ...
        string(defaultValue: 'rodrigordavila/web-php-aws', description: 'Informe o nome de sua imagem (se for registry privado, informe o caminho completo).', name: 'CRONAPP_DOCKER_IMAGE_NAME', trim: false)
        ...
        string(defaultValue: 'https://github.com/rrddevops/bootcamp2.git', description: 'Informe o endereço HTTPS do repositório Git.', name: 'CRONAPP_GIT_URL', trim: false)
